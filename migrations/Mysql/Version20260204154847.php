 ...
 */
final class Version20260204154847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE estimate (id INT AUTO_INCREMENT NOT NULL, building_id INT NOT NULL, concept VARCHAR(255) NOT NULL, measurement_unit VARCHAR(255) NOT NULL, price BIGINT NOT NULL, quantity DOUBLE PRECISION NOT NULL, comment LONGTEXT DEFAULT NULL, discr VARCHAR(255) NOT NULL, INDEX IDX_D2EA46074D2A7E12 (building_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE project_technical_preparation_estimate (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE urbanization_estimate (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE estimate ADD CONSTRAINT FK_D2EA46074D2A7E12 FOREIGN KEY (building_id) REFERENCES building (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE estimate DROP FOREIGN KEY FK_D2EA46074D2A7E12');
