    ...
    private function onPreSetData(FormEvent $event, array $options): void
    {
        ...
        $form
            ...
            ->add('estimatedValueConstruction', MoneyType::class, [
                ...
                'help' => 'El valor de este campo es calculado automaticamente a medida que se llenen las acciones constructivas de los locales de la obra + conexiones de red interna.',
                'row_attr' => [
            ...
            ->add('projectPriceTechnicalPreparation', MoneyPlusType::class, [
                ...
                'attr' => [
                    ...
                    'title' => 'Suma automática de los diferentes conceptos de gastos de proyecto y preparación técnica.',
                ],
                'row_attr' => [
                    'class' => 'disabled-field',
                ],
                'help' => 'Suma automática de los diferentes conceptos de gastos de proyecto y preparación técnica.',
            ...
            ->add('estimatedValueUrbanization', MoneyPlusType::class, [
                ...
                'attr' => [
                    ...
                    'data-type--money-plus-target' => 'field',
                    'data-controller' => 'money',
                    'title' => 'Suma automática de los diferentes conceptos de gastos por urbanización.',
                ],
                'row_attr' => [
                    'class' => 'disabled-field',
                ],
            ...
            ->add('estimatedJustValue', MoneyPlusType::class, [
                ...
                'attr' => [
                    ...
                    'data-type--money-plus-target' => 'field',
                    'data-controller' => 'money',
                    'title' => 'Suma automática de los diferentes conceptos de gastos de valores estiamdos ajustados.',
                ],
                'help' => 'Suma automática de los diferentes conceptos de gastos de valores estiamdos ajustados.',
                'row_attr' => [
                    'class' => 'disabled-field',
                ],
