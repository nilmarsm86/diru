...
final class Version20260724165227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE estimate (id INT AUTO_INCREMENT NOT NULL, measurement_unit_id INT NOT NULL, concept VARCHAR(255) NOT NULL, price BIGINT NOT NULL, quantity DOUBLE PRECISION NOT NULL, comment LONGTEXT DEFAULT NULL, discr VARCHAR(255) NOT NULL, INDEX IDX_D2EA4607B6BD3460 (measurement_unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ite (id INT AUTO_INCREMENT NOT NULL, measurement_unit_id INT NOT NULL, source_id INT NOT NULL, city_id INT NOT NULL, project_type_id INT NOT NULL, type VARCHAR(255) NOT NULL, quality VARCHAR(255) NOT NULL, min DOUBLE PRECISION NOT NULL, max DOUBLE PRECISION NOT NULL, year_reference INT NOT NULL, comment LONGTEXT DEFAULT NULL, source_access VARCHAR(255) DEFAULT NULL, INDEX IDX_CECC0098B6BD3460 (measurement_unit_id), INDEX IDX_CECC0098953C1C61 (source_id), INDEX IDX_CECC00988BAC62AF (city_id), INDEX IDX_CECC0098535280F6 (project_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ite_project_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX ite_project_type_name (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ite_source (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX source_name (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE just_value_estimate (id INT NOT NULL, building_id INT NOT NULL, INDEX IDX_49630CA34D2A7E12 (building_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE measurement_unit (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE planner (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE planner_project (id INT AUTO_INCREMENT NOT NULL, planner_id INT NOT NULL, project_id INT NOT NULL, started_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', finished_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_B0410C215346EAE1 (planner_id), INDEX IDX_B0410C21166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE separate_concept (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, number VARCHAR(255) NOT NULL, formula VARCHAR(255) DEFAULT NULL, percent DOUBLE PRECISION DEFAULT NULL, ignore_number LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', name VARCHAR(255) NOT NULL, INDEX IDX_14FBEE96727ACA70 (parent_id), UNIQUE INDEX separate_concept_number (number), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE urban_regulation (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, measurement_unit_id INT NOT NULL, code VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, data VARCHAR(255) NOT NULL, photo VARCHAR(255) DEFAULT NULL, comment LONGTEXT DEFAULT NULL, legal_reference VARCHAR(255) DEFAULT NULL, structure VARCHAR(255) NOT NULL, INDEX IDX_C3CB3A23C54C8C93 (type_id), INDEX IDX_C3CB3A23B6BD3460 (measurement_unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE estimate ADD CONSTRAINT FK_D2EA4607B6BD3460 FOREIGN KEY (measurement_unit_id) REFERENCES measurement_unit (id)');
        ...
        $this->addSql('ALTER TABLE ite ADD CONSTRAINT FK_CECC0098B6BD3460 FOREIGN KEY (measurement_unit_id) REFERENCES measurement_unit (id)');
        $this->addSql('ALTER TABLE ite ADD CONSTRAINT FK_CECC0098953C1C61 FOREIGN KEY (source_id) REFERENCES ite_source (id)');
        $this->addSql('ALTER TABLE ite ADD CONSTRAINT FK_CECC00988BAC62AF FOREIGN KEY (city_id) REFERENCES city (id)');
        $this->addSql('ALTER TABLE ite ADD CONSTRAINT FK_CECC0098535280F6 FOREIGN KEY (project_type_id) REFERENCES ite_project_type (id)');
        $this->addSql('ALTER TABLE just_value_estimate ADD CONSTRAINT FK_49630CA34D2A7E12 FOREIGN KEY (building_id) REFERENCES building (id)');
        $this->addSql('ALTER TABLE just_value_estimate ADD CONSTRAINT FK_49630CA3BF396750 FOREIGN KEY (id) REFERENCES estimate (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE planner ADD CONSTRAINT FK_95517761BF396750 FOREIGN KEY (id) REFERENCES person (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE planner_project ADD CONSTRAINT FK_B0410C215346EAE1 FOREIGN KEY (planner_id) REFERENCES planner (id)');
        $this->addSql('ALTER TABLE planner_project ADD CONSTRAINT FK_B0410C21166D1F9C FOREIGN KEY (project_id) REFERENCES project (id)');
        ...
        $this->addSql('ALTER TABLE urban_regulation ADD CONSTRAINT FK_C3CB3A23B6BD3460 FOREIGN KEY (measurement_unit_id) REFERENCES measurement_unit (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE estimate DROP FOREIGN KEY FK_D2EA4607B6BD3460');
        ...
        $this->addSql('ALTER TABLE ite DROP FOREIGN KEY FK_CECC0098B6BD3460');
        $this->addSql('ALTER TABLE ite DROP FOREIGN KEY FK_CECC0098953C1C61');
        $this->addSql('ALTER TABLE ite DROP FOREIGN KEY FK_CECC00988BAC62AF');
        $this->addSql('ALTER TABLE ite DROP FOREIGN KEY FK_CECC0098535280F6');
        $this->addSql('ALTER TABLE just_value_estimate DROP FOREIGN KEY FK_49630CA34D2A7E12');
        $this->addSql('ALTER TABLE just_value_estimate DROP FOREIGN KEY FK_49630CA3BF396750');
        ...
        $this->addSql('ALTER TABLE planner DROP FOREIGN KEY FK_95517761BF396750');
        $this->addSql('ALTER TABLE planner_project DROP FOREIGN KEY FK_B0410C215346EAE1');
        $this->addSql('ALTER TABLE planner_project DROP FOREIGN KEY FK_B0410C21166D1F9C');
        ...
        $this->addSql('ALTER TABLE urban_regulation DROP FOREIGN KEY FK_C3CB3A23B6BD3460');
