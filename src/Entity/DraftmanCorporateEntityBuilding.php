...
use App\Repository\DraftmanCorporateEntityBuildingRepository;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Validator\Constraints as Assert;

#[ORM\Entity(repositoryClass: DraftmanCorporateEntityBuildingRepository::class)]
class DraftmanCorporateEntityBuilding
{
    ...
    #[ORM\ManyToOne(cascade: ['persist'], inversedBy: 'draftmanCorporateEntityBuildings')]
    #[ORM\JoinColumn(nullable: false)]
    #[Assert\Valid]
    #[Assert\NotBlank(message: 'Establezca la entidad corporativa de tipo proyectista.')]
    private ?CorporateEntity $corporateEntity = null;

    #[ORM\ManyToOne(inversedBy: 'draftmanCorporateEntityBuildings')]
    #[ORM\JoinColumn(nullable: false)]
    #[Assert\Valid]
