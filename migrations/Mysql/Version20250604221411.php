 ...
 */
final class Version20250604221411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contract (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) DEFAULT NULL, year INT DEFAULT NULL, UNIQUE INDEX contract_code (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
