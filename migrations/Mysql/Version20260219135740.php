 ...
 */
final class Version20260219135740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE building_separate_concept (id INT AUTO_INCREMENT NOT NULL, building_id INT NOT NULL, separate_concept_id INT NOT NULL, percent DOUBLE PRECISION NOT NULL, INDEX IDX_2D9790594D2A7E12 (building_id), INDEX IDX_2D979059754DF490 (separate_concept_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE constructive_system (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE constructor_project (id INT AUTO_INCREMENT NOT NULL, constructor_id INT NOT NULL, project_id INT NOT NULL, started_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', finished_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_36A4D3DC2D98BF9 (constructor_id), INDEX IDX_36A4D3DC166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE corporate_entity_building (id INT AUTO_INCREMENT NOT NULL, corporate_entity_id INT NOT NULL, building_id INT NOT NULL, started_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', finished_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_EDFD80818BA692E5 (corporate_entity_id), INDEX IDX_EDFD80814D2A7E12 (building_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE draftsman_project (id INT AUTO_INCREMENT NOT NULL, draftsman_id INT NOT NULL, project_id INT NOT NULL, started_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', finished_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_389A083940C866FD (draftsman_id), INDEX IDX_389A0839166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE estimate (id INT AUTO_INCREMENT NOT NULL, concept VARCHAR(255) NOT NULL, measurement_unit VARCHAR(255) NOT NULL, price BIGINT NOT NULL, quantity DOUBLE PRECISION NOT NULL, comment LONGTEXT DEFAULT NULL, discr VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE floor (id INT AUTO_INCREMENT NOT NULL, building_id INT NOT NULL, original_id INT DEFAULT NULL, ground_floor TINYINT(1) NOT NULL, position INT NOT NULL, name VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, has_reply TINYINT(1) DEFAULT NULL, INDEX IDX_BE45D62E4D2A7E12 (building_id), UNIQUE INDEX UNIQ_BE45D62E108B7592 (original_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE land (id INT AUTO_INCREMENT NOT NULL, land_area DOUBLE PRECISION NOT NULL, occupied_area DOUBLE PRECISION NOT NULL, perimeter DOUBLE PRECISION DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, microlocalization VARCHAR(255) DEFAULT NULL, floor INT NOT NULL, is_blocked TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE land_network_connection (id INT AUTO_INCREMENT NOT NULL, building_id INT NOT NULL, network_connection_id INT NOT NULL, land_network_connection_constructive_action_id INT DEFAULT NULL, explanation LONGTEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, longitude DOUBLE PRECISION NOT NULL, technical_status VARCHAR(255) NOT NULL, INDEX IDX_7BF47B3B4D2A7E12 (building_id), INDEX IDX_7BF47B3B4EDCA4BC (network_connection_id), UNIQUE INDEX UNIQ_7BF47B3B754933F6 (land_network_connection_constructive_action_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE land_network_connection_constructive_action (id INT AUTO_INCREMENT NOT NULL, constructive_action_id INT DEFAULT NULL, constructive_system_id INT DEFAULT NULL, price BIGINT NOT NULL, INDEX IDX_388F0AC7369941F1 (constructive_action_id), INDEX IDX_388F0AC77B3E9E61 (constructive_system_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE local (id INT AUTO_INCREMENT NOT NULL, sub_system_id INT NOT NULL, local_constructive_action_id INT DEFAULT NULL, original_id INT DEFAULT NULL, number VARCHAR(255) NOT NULL, area DOUBLE PRECISION NOT NULL, type VARCHAR(255) NOT NULL, height DOUBLE PRECISION NOT NULL, impact_higher_levels TINYINT(1) NOT NULL, comment LONGTEXT DEFAULT NULL, name VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, has_reply TINYINT(1) DEFAULT NULL, technical_status VARCHAR(255) NOT NULL, INDEX IDX_8BD688E8C298691B (sub_system_id), UNIQUE INDEX UNIQ_8BD688E8460C8FAC (local_constructive_action_id), UNIQUE INDEX UNIQ_8BD688E8108B7592 (original_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE local_constructive_action (id INT AUTO_INCREMENT NOT NULL, constructive_action_id INT DEFAULT NULL, constructive_system_id INT DEFAULT NULL, price BIGINT NOT NULL, INDEX IDX_EECA25F5369941F1 (constructive_action_id), INDEX IDX_EECA25F57B3E9E61 (constructive_system_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, contract_id INT DEFAULT NULL, investment_id INT NOT NULL, currency_id INT NOT NULL, client_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, stop_reason LONGTEXT DEFAULT NULL, register_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', stopped_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', canceled_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', initiated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', terrain_diagnosis_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', urban_regulation_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', design_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', comment LONGTEXT DEFAULT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_2FB3D0EE2576E0FD (contract_id), INDEX IDX_2FB3D0EE6E1B4FD5 (investment_id), INDEX IDX_2FB3D0EE38248176 (currency_id), INDEX IDX_2FB3D0EE19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project_technical_preparation_estimate (id INT NOT NULL, building_id INT NOT NULL, INDEX IDX_39DA26B14D2A7E12 (building_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project_urban_regulation (id INT AUTO_INCREMENT NOT NULL, urban_regulation_id INT NOT NULL, project_id INT NOT NULL, data VARCHAR(255) NOT NULL, reference LONGTEXT DEFAULT NULL, INDEX IDX_7E4EF94A7555F80B (urban_regulation_id), INDEX IDX_7E4EF94A166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE separate_concept (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, number VARCHAR(255) NOT NULL, formula VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_14FBEE96727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sub_system (id INT AUTO_INCREMENT NOT NULL, floor_id INT NOT NULL, subsystem_type_subsystem_sub_type_id INT DEFAULT NULL, original_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, has_reply TINYINT(1) DEFAULT NULL, INDEX IDX_7B1C5EC7854679E2 (floor_id), INDEX IDX_7B1C5EC74216BAA1 (subsystem_type_subsystem_sub_type_id), UNIQUE INDEX UNIQ_7B1C5EC7108B7592 (original_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE subsystem_sub_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE subsystem_type (id INT AUTO_INCREMENT NOT NULL, classification VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE subsystem_type_subsystem_sub_type (id INT AUTO_INCREMENT NOT NULL, subsystem_type_id INT DEFAULT NULL, subsystem_sub_type_id INT DEFAULT NULL, INDEX IDX_EC809E3349C277F0 (subsystem_type_id), INDEX IDX_EC809E336B986E75 (subsystem_sub_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE urban_regulation (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, code VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, data VARCHAR(255) NOT NULL, measurement_unit VARCHAR(255) NOT NULL, photo VARCHAR(255) DEFAULT NULL, comment LONGTEXT DEFAULT NULL, legal_reference VARCHAR(255) DEFAULT NULL, structure VARCHAR(255) NOT NULL, INDEX IDX_C3CB3A23C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE urban_regulation_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE urbanization_estimate (id INT NOT NULL, building_id INT NOT NULL, INDEX IDX_89AA13F84D2A7E12 (building_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE constructor_project ADD CONSTRAINT FK_36A4D3DC2D98BF9 FOREIGN KEY (constructor_id) REFERENCES constructor (id)');
        $this->addSql('ALTER TABLE constructor_project ADD CONSTRAINT FK_36A4D3DC166D1F9C FOREIGN KEY (project_id) REFERENCES project (id)');
        ...
        $this->addSql('ALTER TABLE corporate_entity_building ADD CONSTRAINT FK_EDFD80818BA692E5 FOREIGN KEY (corporate_entity_id) REFERENCES corporate_entity (id)');
        $this->addSql('ALTER TABLE corporate_entity_building ADD CONSTRAINT FK_EDFD80814D2A7E12 FOREIGN KEY (building_id) REFERENCES building (id)');
        ...
        $this->addSql('ALTER TABLE draftsman_project ADD CONSTRAINT FK_389A083940C866FD FOREIGN KEY (draftsman_id) REFERENCES draftsman (id)');
        $this->addSql('ALTER TABLE draftsman_project ADD CONSTRAINT FK_389A0839166D1F9C FOREIGN KEY (project_id) REFERENCES project (id)');
        ...
        $this->addSql('ALTER TABLE land_network_connection ADD CONSTRAINT FK_7BF47B3B4D2A7E12 FOREIGN KEY (building_id) REFERENCES building (id)');
        ...
        $this->addSql('ALTER TABLE land_network_connection ADD CONSTRAINT FK_7BF47B3B754933F6 FOREIGN KEY (land_network_connection_constructive_action_id) REFERENCES land_network_connection_constructive_action (id)');
        $this->addSql('ALTER TABLE land_network_connection_constructive_action ADD CONSTRAINT FK_388F0AC7369941F1 FOREIGN KEY (constructive_action_id) REFERENCES constructive_action (id)');
        $this->addSql('ALTER TABLE land_network_connection_constructive_action ADD CONSTRAINT FK_388F0AC77B3E9E61 FOREIGN KEY (constructive_system_id) REFERENCES constructive_system (id)');
        ...
        $this->addSql('ALTER TABLE local_constructive_action ADD CONSTRAINT FK_EECA25F57B3E9E61 FOREIGN KEY (constructive_system_id) REFERENCES constructive_system (id)');
        ...
        $this->addSql('ALTER TABLE project_technical_preparation_estimate ADD CONSTRAINT FK_39DA26B14D2A7E12 FOREIGN KEY (building_id) REFERENCES building (id)');
        $this->addSql('ALTER TABLE project_technical_preparation_estimate ADD CONSTRAINT FK_39DA26B1BF396750 FOREIGN KEY (id) REFERENCES estimate (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE project_urban_regulation ADD CONSTRAINT FK_7E4EF94A7555F80B FOREIGN KEY (urban_regulation_id) REFERENCES urban_regulation (id)');
        $this->addSql('ALTER TABLE project_urban_regulation ADD CONSTRAINT FK_7E4EF94A166D1F9C FOREIGN KEY (project_id) REFERENCES project (id)');
        ...
        $this->addSql('ALTER TABLE separate_concept ADD CONSTRAINT FK_14FBEE96727ACA70 FOREIGN KEY (parent_id) REFERENCES separate_concept (id)');
        $this->addSql('ALTER TABLE sub_system ADD CONSTRAINT FK_7B1C5EC7854679E2 FOREIGN KEY (floor_id) REFERENCES floor (id)');
        $this->addSql('ALTER TABLE sub_system ADD CONSTRAINT FK_7B1C5EC74216BAA1 FOREIGN KEY (subsystem_type_subsystem_sub_type_id) REFERENCES subsystem_type_subsystem_sub_type (id)');
        $this->addSql('ALTER TABLE sub_system ADD CONSTRAINT FK_7B1C5EC7108B7592 FOREIGN KEY (original_id) REFERENCES sub_system (id)');
        $this->addSql('ALTER TABLE subsystem_type_subsystem_sub_type ADD CONSTRAINT FK_EC809E3349C277F0 FOREIGN KEY (subsystem_type_id) REFERENCES subsystem_type (id)');
        $this->addSql('ALTER TABLE subsystem_type_subsystem_sub_type ADD CONSTRAINT FK_EC809E336B986E75 FOREIGN KEY (subsystem_sub_type_id) REFERENCES subsystem_sub_type (id)');
        $this->addSql('ALTER TABLE urban_regulation ADD CONSTRAINT FK_C3CB3A23C54C8C93 FOREIGN KEY (type_id) REFERENCES urban_regulation_type (id)');
        $this->addSql('ALTER TABLE urbanization_estimate ADD CONSTRAINT FK_89AA13F84D2A7E12 FOREIGN KEY (building_id) REFERENCES building (id)');
        $this->addSql('ALTER TABLE urbanization_estimate ADD CONSTRAINT FK_89AA13F8BF396750 FOREIGN KEY (id) REFERENCES estimate (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE constructor_project DROP FOREIGN KEY FK_36A4D3DC2D98BF9');
        $this->addSql('ALTER TABLE constructor_project DROP FOREIGN KEY FK_36A4D3DC166D1F9C');
        ...
        $this->addSql('ALTER TABLE corporate_entity_building DROP FOREIGN KEY FK_EDFD80818BA692E5');
        $this->addSql('ALTER TABLE corporate_entity_building DROP FOREIGN KEY FK_EDFD80814D2A7E12');
        ...
        $this->addSql('ALTER TABLE draftsman_project DROP FOREIGN KEY FK_389A083940C866FD');
        $this->addSql('ALTER TABLE draftsman_project DROP FOREIGN KEY FK_389A0839166D1F9C');
        ...
        $this->addSql('ALTER TABLE land_network_connection DROP FOREIGN KEY FK_7BF47B3B4D2A7E12');
        $this->addSql('ALTER TABLE land_network_connection DROP FOREIGN KEY FK_7BF47B3B4EDCA4BC');
        $this->addSql('ALTER TABLE land_network_connection DROP FOREIGN KEY FK_7BF47B3B754933F6');
        $this->addSql('ALTER TABLE land_network_connection_constructive_action DROP FOREIGN KEY FK_388F0AC7369941F1');
        $this->addSql('ALTER TABLE land_network_connection_constructive_action DROP FOREIGN KEY FK_388F0AC77B3E9E61');
        ...
        $this->addSql('ALTER TABLE local_constructive_action DROP FOREIGN KEY FK_EECA25F57B3E9E61');
        ...
        $this->addSql('ALTER TABLE project_technical_preparation_estimate DROP FOREIGN KEY FK_39DA26B14D2A7E12');
        $this->addSql('ALTER TABLE project_technical_preparation_estimate DROP FOREIGN KEY FK_39DA26B1BF396750');
        $this->addSql('ALTER TABLE project_urban_regulation DROP FOREIGN KEY FK_7E4EF94A7555F80B');
        $this->addSql('ALTER TABLE project_urban_regulation DROP FOREIGN KEY FK_7E4EF94A166D1F9C');
        $this->addSql('ALTER TABLE representative DROP FOREIGN KEY FK_2507390EBF396750');
        $this->addSql('ALTER TABLE separate_concept DROP FOREIGN KEY FK_14FBEE96727ACA70');
        $this->addSql('ALTER TABLE sub_system DROP FOREIGN KEY FK_7B1C5EC7854679E2');
        $this->addSql('ALTER TABLE sub_system DROP FOREIGN KEY FK_7B1C5EC74216BAA1');
        $this->addSql('ALTER TABLE sub_system DROP FOREIGN KEY FK_7B1C5EC7108B7592');
        $this->addSql('ALTER TABLE subsystem_type_subsystem_sub_type DROP FOREIGN KEY FK_EC809E3349C277F0');
        $this->addSql('ALTER TABLE subsystem_type_subsystem_sub_type DROP FOREIGN KEY FK_EC809E336B986E75');
        $this->addSql('ALTER TABLE urban_regulation DROP FOREIGN KEY FK_C3CB3A23C54C8C93');
        $this->addSql('ALTER TABLE urbanization_estimate DROP FOREIGN KEY FK_89AA13F84D2A7E12');
        $this->addSql('ALTER TABLE urbanization_estimate DROP FOREIGN KEY FK_89AA13F8BF396750');
