 ...
 */
final class Version20250527225939 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE draftsman_proyect (id INT AUTO_INCREMENT NOT NULL, draftsman_id INT NOT NULL, project_id INT NOT NULL, started_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', finished_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7A36F04840C866FD (draftsman_id), INDEX IDX_7A36F048166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, contract_id INT DEFAULT NULL, investment_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, stop_reason LONGTEXT DEFAULT NULL, has_occupied_area TINYINT(1) NOT NULL, register_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', stopped_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', canceled_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', initiated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', terrain_diagnosis_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', urban_rregulation_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', design_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', comment LONGTEXT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_2FB3D0EE19EB6921 (client_id), UNIQUE INDEX UNIQ_2FB3D0EE2576E0FD (contract_id), UNIQUE INDEX UNIQ_2FB3D0EE6E1B4FD5 (investment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE representative (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE draftsman_proyect ADD CONSTRAINT FK_7A36F04840C866FD FOREIGN KEY (draftsman_id) REFERENCES draftsman (id)');
        $this->addSql('ALTER TABLE draftsman_proyect ADD CONSTRAINT FK_7A36F048166D1F9C FOREIGN KEY (project_id) REFERENCES project (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE draftsman_proyect DROP FOREIGN KEY FK_7A36F04840C866FD');
        $this->addSql('ALTER TABLE draftsman_proyect DROP FOREIGN KEY FK_7A36F048166D1F9C');
