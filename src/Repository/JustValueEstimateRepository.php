...
/**
 * @extends ServiceEntityRepository<JustValueEstimate>
 */
class JustValueEstimateRepository extends ServiceEntityRepository implements FilterInterface
{
    use SaveData;
    use PaginateTrait;
    ...
    {
        parent::__construct($registry, JustValueEstimate::class);
    }
