 ...
 */
final class Version20250801024359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE floor (id INT AUTO_INCREMENT NOT NULL, building_id INT NOT NULL, original_id INT DEFAULT NULL, ground_floor TINYINT(1) NOT NULL, position INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_BE45D62E4D2A7E12 (building_id), UNIQUE INDEX UNIQ_BE45D62E108B7592 (original_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sub_system (id INT AUTO_INCREMENT NOT NULL, floor_id INT NOT NULL, original_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_7B1C5EC7854679E2 (floor_id), UNIQUE INDEX UNIQ_7B1C5EC7108B7592 (original_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
